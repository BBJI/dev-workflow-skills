...
try {
    ...
    if (s.hooks) {
        ...
        console.log('  ✅ 已移除 Dashboard 问答 Hooks');
        changed = true;
    }
    if (changed) {
...
try {
    ...
    // Replace existing AskUserQuestion hooks or add new ones
    ...
    console.log('  ✅ Dashboard 问答 Hooks 已配置');
    changed = true;
